...
Once successfully validated, click __Publish__ on top right to publish the project with a configuration name that you can later find, for instance __TechEdXX-V1__.
